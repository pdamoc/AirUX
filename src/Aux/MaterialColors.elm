...
@docs blackText, whiteText, primaries, variants
-}
...
{-| -}
type ZaiColor
    = C PrimaryColor Variant
    | BW BlackOrWhite BWVariant
...
blackText : String
blackText =
    toColorString (BW Black Text)


{-| -}
whiteText : String
whiteText =
    toColorString (BW White Text)
...
toHex p v =
    let
        ...
        cn =
            pn
                ++ if String.startsWith "A" vn then
                    vn
                   else
                    (String.dropLeft 1 vn)
    in
